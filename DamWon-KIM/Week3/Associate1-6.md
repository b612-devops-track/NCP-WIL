...
NCE : NCP에 대한 전문적인 지식이 있고 트러블 슈팅과 커스터마이징이 가능한 수준
NCP : NCP에 대한 전문적인 지식이 있고 NCP를 활용하여 인프라를 독자적으로 구축할 뿐만 아니라 다양한 기능을 구현할 수 있는 수준
NCA : NCP에 대한 기본적인 이해가 있고 NCP를 이용한 인프라 구성이 가능한 수준
